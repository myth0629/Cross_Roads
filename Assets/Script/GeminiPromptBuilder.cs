...
public static class GeminiPromptBuilder
{
	public static string BuildUnifiedPrompt(GameState state)
	{
		...
		return
			...
			"**[Step 1: 'situation_text' 생성 - 기승전결 구조 필수]**\n" +
			"* 'GameState'의 'lastPlayerAction'과 'turnsRemaining'을 분석합니다.\n" +
			"    * 만약 'lastPlayerAction'이 \"GameStart\"이거나 null이라면, 게임의 배경과 첫 번째 딜레마를 묘사하는 도입부 텍스트를 생성합니다.\n" +
			"    * 그 외의 경우, 'lastPlayerAction'이 현재 'GameState'(자원, 줄거리)에 어떤 영향을 미쳤는지 분석하여 기승전결 구조로 작성합니다.\n\n" +
			"* **기승전결 구조 (반드시 4단계 포함):**\n" +
			"  1. **기(起) - 상황 설정**: 이전 선택의 직접적인 결과를 1-2문장으로 제시\n" +
			"     예: \"당신의 결정으로 식량 창고의 문이 열렸다. 몰려든 생존자들은 질서 정연하게 배급을 받았다.\"\n" +
			"  \n" +
			"  2. **승(承) - 전개**: 그 결과가 예상치 못한 2차 파장을 일으킴 (1-2문장)\n" +
			"     예: \"하지만 밤이 되자, 배급량이 불공평했다는 소문이 퍼지기 시작했다. 일부 생존자들이 몰래 모임을 갖는 것이 목격되었다.\"\n" +
			"  \n" +
			"  3. **전(轉) - 위기/전환점**: 긴장이 최고조에 달하는 새로운 사건 발생 (1-2문장)\n" +
			"     예: \"새벽 3시, 비상벨이 울렸다. CCTV를 확인한 당직자가 다급히 보고한다 - 누군가 식량 창고의 자물쇠를 부수려 하고 있다.\"\n" +
			"  \n" +
			"  4. **결(結) - 딜레마 제시**: 플레이어에게 즉각적인 결정을 요구하는 긴박한 상황으로 마무리 (1문장)\n" +
			"     예: \"경비원들이 당신의 명령을 기다리고 있다. 지금 결정하지 않으면 상황이 걷잡을 수 없이 악화될 것이다.\"\n\n" +
			"* **턴 수에 따른 분위기 조절:**\n" +
			"  - 초반 (턴 14-11): 혼란스럽지만 희망적, 새로운 동맹 가능성\n" +
			"  - 중반 (턴 10-6): 갈등 심화, 배신과 의심, 자원 부족 가시화\n" +
			"  - 후반 (턴 5-1): 극한 상황, 생존을 위한 극단적 선택, 도덕적 붕괴\n\n" +
			"* **중요**: 매 턴마다 새로운 등장인물이나 예상치 못한 사건을 도입하여 상황을 다채롭게 만드세요.\n" +
			"* 단순히 \"의사가 요청한다\" \"환자가 고통받는다\"와 같은 반복적인 패턴을 피하세요.\n" +
			"* 총 길이는 6-8문장 내외로, 기승전결이 명확히 구분되도록 작성하세요.\n\n" +
			"**[Step 2: 'choices' 생성]**\n" +
			...
			"  - \"정체불명의 남자가 제안한 '암시장 거래'를 수락한다 (소문 퍼질 위험)\"\n" +
